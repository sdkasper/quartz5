---
aliases:
  - obsidian/tweaks/css-table-styles
author:
  - Sascha D. Kasper
source: https://blog.sascha-kasper.com/CSS---Table-Styles
description: Apply five different table themes to your Obsidian notes using cssclasses -- from corporate blue to academic LaTeX style.
cover:
date: 2024-11-09
draft: false
categories:
...
Click on the folder icon. This should open the local folder containing the snippets. Create a new file and give it a name that makes sense to you. For example, `table styles.css`. Make sure that the file extension is `css`. If you don't see your file extensions, click on `View`, `Show`, and `File name extensions` (in Windows Explorer).
...
# Result
The snippet contains various table styles - which you can adapt, or course - letting you apply specific classes to a note to modify all the tables in that note. Here are the screenshots from the forum entry linked above.
![[CSS - Table Styles-20241109210828167.webp|Purple Red table theme with pink header and dark purple rows]]

![[CSS - Table Styles-20241109210837558.webp|LaTeX-style academia table with clean borders and alternating row shading]]

![[CSS - Table Styles-20241109210843226.webp|Yellow Cab table theme with bold orange header and light gray rows]]

![[CSS - Table Styles-20241109210849685.webp|White Red table theme with red header text on white background]]

![[CSS - Table Styles-20241109210855339.webp|Flat Blue corporate table theme with blue header and striped rows]]
...
I found this on the [Obsidian Forum](https://forum.obsidian.md/t/custom-css-for-tables-5-new-styles-ready-to-use-in-your-notes/17084), posted by user [DeaconLight](https://forum.obsidian.md/u/DeaconLight).
