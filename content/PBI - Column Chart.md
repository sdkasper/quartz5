...
author:
  - Sascha D. Kasper
description: Theme the stacked column chart in Power BI with JSON settings for axes, labels, totals, and data points.
cover:
date: 2023-09-11
draft: false
categories:
...
The `"columnChart"` is actually a **stacked column chart** and not to be confused with the [[Clustered Column Chart]].
...
## Effect
![[Column Chart Stacked.webp]]

## Settings
>[!attention] With the chart selected

![[Column Chart Stacked Settings.webp]]
