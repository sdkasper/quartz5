...
author:
  - Sascha D. Kasper
description: Style the 100% stacked bar chart in Power BI with theme JSON for axes, labels, totals, and data points.
cover:
date: 2023-09-11
draft: false
categories:
...
The `"hundredPercentStackedBarchart"` is not to be confused with the stacked [[Bar Chart]].
...
## Effect
![[Bar Chart Hundred Percent Stacked.webp]]

## Settings
>[!attention] With the chart selected

![[Bar Chart Hundred Percent Stacked Settings.webp]]
