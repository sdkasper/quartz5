...
author:
  - Sascha D. Kasper
description: Style the 100% stacked column chart in Power BI with theme JSON for axes, labels, totals, and data points.
cover:
date: 2023-09-11
draft: false
categories:
...
The `"hundredPercentStackedColumnChart"` is not to be confused with the stacked [[Column Chart]].
...
## Effect
![[Column Chart Hundred Percent Stacked.webp]]

## Settings
>[!attention] With the chart selected

![[Column Chart Hundred Percent Stacked Settings.webp]]
