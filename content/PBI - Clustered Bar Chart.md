...
author:
  - Sascha D. Kasper
description: Theme the clustered bar chart in Power BI with JSON settings for axes, labels, data points, and gridlines.
cover:
date: 2023-09-11
draft: false
categories:
...
The `"clusteredBarChart"` is not to be confused with the stacked [[Bar Chart]].
    ...
    "visualStyles": {
		"clusteredBarChart": {
			"*": {
				...
				"dataPoint_": [{
					"defaultColor": { "solid": { "color": "#FFFFFF"}}
				}],
				"labels_": [{
					"show": true,
					...
					"backgroundColor_": { "solid": { "color": "#1B2631"}},
...
## Effect
![[Bar Chart Clustered.webp]]

## Settings
>[!attention] With the chart selected

![[Bar Chart Clustered Settings.webp]]
