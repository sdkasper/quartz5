...
author:
  - Sascha D. Kasper
description: Customize the KPI visual in Power BI theme JSON with indicator, trendline, goal, and status color settings.
cover:
date: 2023-09-11
draft: false
categories:
		...
		"kpi": {
			"*": {
				...
				"goals": [{
					"showGoal": true,
					"showDistance": true,
					"goalFontColor": { "solid": { "color": "#25D0F7" } },
					"goalFontFamily": "wf_standard-font, helvetica, arial, sans-serif",
					"fontSize": 10,
					"distanceLabel": "Value, percent",
					"labelPrecision": 2,
				...
				"status": [{
					"direction": "Positive",
					"goodColor": { "solid": { "color": "#18BC9C" } },
					"neutralColor": { "solid": { "color": "#FFD700" } },
					"badColor": { "solid": { "color": "#FC3634" } }
				}],
				"lastDate": [{
					"show": true,
					"lastDateFontColor": { "solid": { "color": "#B3B3B3" } },
					"lastDateFontFamily": "Segoe UI",
					"fontSize": 10
				}],
				"general_": [{
					"responsive": true,
