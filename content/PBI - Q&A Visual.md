...
author:
  - Sascha D. Kasper
description: Theme the Q&A visual in Power BI with JSON settings for styling the natural language query experience.
cover:
date: 2023-09-11
draft: false
categories:
		...
		"qnaVisual": {
			"*": {
				"inputBox": [{
					...
					"questionFontColor": { "solid": { "color": "#1C1C1C" } },
					"questionFontSize": 10,
					"questionFontFamily": "Segoe UI",
					"acceptedColor": { "solid": { "color": "#18BC9C" } },
					"errorColor": { "solid": { "color": "#FC3634" } },
					"warningColor": { "solid": { "color": "#FFD700" } },
					"hoverColor": { "solid": { "color": "#B3B3B3" } },
					"restatementFontColor": { "solid": { "color": "#1C1C1C" } },
					"restatementFontSize": 10,
					"restatementFontFamily": "Segoe UI"
				}],
				"suggestions": [{
					"show": true,
					"headerFontColor": { "solid": { "color": "#FFFFFF" } },
					"headerFontSize": 10,
					"headerFontFamily": "Segoe UI",
					"cardBackground": { "solid": { "color": "#1B2631" } },
					"cardFontColor": { "solid": {"color": "#FFFFFF"} },
					"cardFontSize": 10,
