...
author:
  - Sascha D. Kasper
description: Theme the waterfall chart in Power BI with JSON settings for sentiment colors, labels, and connector lines.
cover:
date: 2023-09-11
draft: false
categories:
		...
		"waterfallChart": {
			"*": {
			  "general_": [{
				...
				"sentimentColors": [{
					"increaseFill": {	"solid": { "color": "#18BC9C" } },
					"decreaseFill": { "solid": { "color": "#FC3634" } },
					"totalFill": { "solid": { "color": "#007BFF" } },
					"otherFill": { "solid": { "color": "#000000" } }
				}],
				"legend_": [{
					"show": true,
					"position": "Top",
...
## Effect
![[Waterfall Chart.webp]]

## Settings
>[!attention] With the chart selected

![[Waterfall Chart Settings.webp]]
