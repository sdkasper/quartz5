...
author:
  - Sascha D. Kasper
description: Theme the shape map visual in Power BI with JSON settings for region colors, labels, and data points.
cover:
date: 2023-09-11
draft: false
categories:
    ...
    "visualStyles": {
		"shapeMap": {
			"*": {
				...
				"defaultColors": [{
					"defaultShow": true,
					"defaultColor": { "solid": { "color": "#DBDBDB" } },
