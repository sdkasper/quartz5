...
author:
  - Sascha D. Kasper
description: Customize the clustered column chart in your Power BI theme with axes, labels, totals, and header settings.
cover:
date: 2023-09-11
draft: false
categories:
...
The `"clusteredColumnChart"` is not to be confused with the stacked [[Column Chart]].
...
## Effect
![[Column Chart Clustered.webp]]

## Settings
>[!attention] With the chart selected

![[Column Chart Clustered Settings.webp]]
