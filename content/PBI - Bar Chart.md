...
author:
  - Sascha D. Kasper
description: Theme the stacked bar chart in Power BI with JSON settings for axes, labels, totals, and data points.
cover:
date: 2023-09-11
draft: false
categories:
...
The `"barChart"` is actually a **stacked bar chart** and not to be confused with the [[Clustered Bar Chart]].
...
## Effect
![[Bar Chart Stacked.webp]]

## Settings
>[!attention] With the chart selected

![[Bar Chart Stacked Settings.webp]]
