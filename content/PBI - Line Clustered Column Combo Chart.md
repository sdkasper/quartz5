...
author:
  - Sascha D. Kasper
description: Theme the line and clustered column combo chart in Power BI with line styles, markers, and axis settings.
cover:
date: 2023-09-11
draft: false
categories:
			...
			"*": {
			  "general_": [{
				...
				"lineStyles": [{
					  ...
					  "markerShape": "circle",
					  "markerSize": 5,
					  "markerColor": { "solid": { "color": "#FFFFFF" } },
					  "stepped": true
				}],
				"plotArea_": [{
...
## Effect
![[Line Chart Clustered Column Combo.webp]]

## Settings
>[!attention] With the chart selected

![[Line Chart Clustered Column Combo Settings.webp]]
